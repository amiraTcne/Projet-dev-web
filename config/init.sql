...
INSERT INTO Utilisateur (nom,prenom,email,mot_de_passe,actif,role_premier,role_second,role_troisieme,filiere,niveau, annee_promo,specialite,departement,commission,annee_jury,num_siret,nom_entreprise,secteur,adresse,ville,code_postal,site_web,nb_stagiere) VALUES ('Martin','Marc','marc.martin@universite.fr','admin26.',1,'Admin',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO Utilisateur (nom, prenom, email, mot_de_passe, actif, role_premier, num_siret, nom_entreprise, secteur, adresse, ville, code_postal, site_web, nb_stagiere) VALUES ('Dupont', 'Jean', 'contact@techcorp.fr', 'entreprise26.', 1, 'Entreprise', '12345678901234', 'TechCorp SAS', 'Informatique', '12 rue de la Paix', 'Paris', '75001', 'https://techcorp.fr', 0);
INSERT INTO Utilisateur (nom, prenom, email, mot_de_passe, actif, role_premier, specialite, commission, annee_jury) VALUES ('Bernard', 'Sophie', 'sophie.bernard@universite.fr', 'jurys26.', 1, 'Jury', 'Informatique & IA', 'Commission Ingénierie', 2024);
INSERT INTO Utilisateur (nom, prenom, email, mot_de_passe, actif, role_premier, specialite, departement) VALUES ('Lefebvre', 'Pierre', 'pierre.lefebvre@universite.fr','tuteur26.', 1, 'Tuteur', 'Mathématiques Appliquées', 'Département Sciences');

INSERT INTO Offre_Stage (titre, mission, competences, filiere_ciblee, duree_semaines, date_debut, statut, id_entreprise) VALUES ('Développeur Web Full-Stack', 'Développement et maintenance d une application web interne.', 'PHP, MySQL, JavaScript', 'Informatique', 12, '2026-06-01', 'ouverte', 3);